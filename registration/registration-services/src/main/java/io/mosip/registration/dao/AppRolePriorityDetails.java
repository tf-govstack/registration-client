 ...
 * from the {@link io.github.tf-govstack.registration.entity.AppRolePriority} table.
 * 
...
public interface AppRolePriorityDetails {
	 ...
	 * from the {@link io.github.tf-govstack.registration.entity.AppRolePriority} table as given in Embeddable.
	 *  
	 * @return {@link io.github.tf-govstack.registration.entity.AppRolePriority}
	 */
	AppRolePriority getAppRolePriorityId();
	
	/**
	 * This class defines the columns which are needed to be selected and fetched
	 * from the {@link io.github.tf-govstack.registration.entity.AppRolePriority}.
	   */
